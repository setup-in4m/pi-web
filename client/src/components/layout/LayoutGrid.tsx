...
export function LayoutGrid() {
  ...
  const renderSingle = () => (
    <div className="flex-1 bg-[var(--color-bg)] overflow-hidden min-h-0 h-full outline-2 outline-[var(--color-accent)] outline-offset-[-2px] shadow-[inset_-2px_-2px_0_0_var(--color-accent)]">
      <ErrorBoundary>
