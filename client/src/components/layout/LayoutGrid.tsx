...
export function LayoutGrid() {
  ...
  const renderSingle = () => (
    <div className="flex-1 bg-[var(--color-bg)] overflow-hidden min-h-0 h-full outline-2 outline-[var(--color-accent)] outline-offset-[-2px] shadow-[inset_0_0_0_2px_var(--color-accent)]">
      <ErrorBoundary>
